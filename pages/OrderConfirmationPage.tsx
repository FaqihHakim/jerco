...
const OrderConfirmationPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="bg-white p-8 md:p-12 rounded-xl shadow-lg max-w-3xl mx-auto text-center border">
        ...
        <div className="text-left bg-gray-50 p-6 rounded-lg mb-8 border border-gray-200">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between"><span className="text-gray-600">Shipping Address:</span> <strong>{order.shipping_address}</strong></div>
        ...
        <p className="text-gray-500 text-sm mb-8">You will receive an email confirmation shortly with your order details. If you have any questions, please contact our customer support.</p>
