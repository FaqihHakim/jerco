...
export const mockProducts: Omit<Product, 'brand'>[] = [
  ...
  { id: '101', name: 'Pro-Vent Football Shorts - White', description: 'White professional football shorts with moisture-wicking technology.', price: 350000, stock_quantity: 60, image_url: 'https://images.tokopedia.net/img/cache/700/VqbcmM/2025/1/13/a02789a5-9738-43c3-ab05-9c7bddf26419.png', brand_id: '1', sizes: ['S', 'M', 'L', 'XL'], category: 'shorts' },
  { id: '102', name: 'Essential Football Shorts - Black', description: 'Classic black shorts, perfect for training or match day.', price: 320000, stock_quantity: 80, image_url: 'https://images.tokopedia.net/img/cache/700/VqbcmM/2025/1/13/a02789a5-9738-43c3-ab05-9c7bddf26419.png', brand_id: '2', sizes: ['S', 'M', 'L', 'XL'], category: 'shorts' },
  { id: '103', name: 'Team Royal Blue Shorts', description: 'Vibrant royal blue shorts to match your team colors.', price: 340000, stock_quantity: 45, image_url: 'https://images.tokopedia.net/img/cache/700/VqbcmM/2025/1/13/a02789a5-9738-43c3-ab05-9c7bddf26419.png', brand_id: '2', sizes: ['S', 'M', 'L'], category: 'shorts' },
  { id: '201', name: 'Performance Crew Socks - White', description: 'High-performance white football socks with cushioned support.', price: 150000, stock_quantity: 100, image_url: 'https://images.tokopedia.net/img/cache/700/VqbcmM/2025/1/13/a02789a5-9738-43c3-ab05-9c7bddf26419.png', brand_id: '1', sizes: ['One Size'], category: 'socks' },
  { id: '202', name: 'Strike Football Socks - Black', description: 'Sleek black football socks with strategic padding.', price: 160000, stock_quantity: 90, image_url: 'https://images.tokopedia.net/img/cache/700/VqbcmM/2025/1/13/a02789a5-9738-43c3-ab05-9c7bddf26419.png', brand_id: '2', sizes: ['One Size'], category: 'socks' },
  { id: '203', name: 'Team Color Socks - Red', description: 'Classic red socks to complete your kit.', price: 140000, stock_quantity: 120, image_url: 'https://images.tokopedia.net/img/cache/700/VqbcmM/2025/1/13/a02789a5-9738-43c3-ab05-9c7bddf26419.png', brand_id: '1', sizes: ['One Size'], category: 'socks' },
];
